...
//	srSpace*  m_Space;
	...
	*/
	...
	void		DIFFKIN_IntegratePosition(real & _step);
	void		(srSystem::*m_pfn_diffkin_integrateposition)(real & _step);
	void		__FS_IntegratePosition_Euler(real & _step);
	void		__L_IntegratePosition_Euler(real & _step);
	...
	void		DYN_ForwardDynamics_Set00(real & _step);
	void		(srSystem::*m_pfn_dyn_forwarddynamics_set00)(real & _step);
	void		_FS_ForwardDynamics_Set00(real & _step);
	void		_L_ForwardDynamics_Set00(real & _step);

	void		__FS_UpdateArticulatedInertia();
	void		__FS_UpdateBiasforce();
	void		__FS_UpdateAcceleration();
	void		__FS_IntegrateVelocity_Euler(real & _step);


	void		__L_UpdateBiasforce();
	void		__L_UpdateAcceleration();
	void		__L_IntegrateVelocity_Euler(real & _step);

	void		DYN_ImpulseDynamics_Set00(real & _fps);
	void		(srSystem::*m_pfn_dyn_impulsedynamics_set00)(real & _fps);
	void		_FS_Impulsedynamics_set00(real & _fps);
	void		_L_Impulsedynamics_set00(real & _fps);

	void		__FS_UpdateBiasImpulse();
	void		__FS_UpdateDelVelocity(real & _fps);
	void		__FS_UpdateVelocity_with_DelVelocity();
	void		__FS_UpdateAcceleration_with_DelVelocity(real & _fps);

	void		__L_UpdateDelVelocity();
	void		__L_UpdateVelocity_with_DelVelocity();
	void		__L_UpdateAcceleration_with_DelVelocity(real & _fps);

	void		DYN_IntegratePosition_Set00(real & _step);
	void		(srSystem::*m_pfn_dyn_integrateposition_set00)(real & _step);
	void		_FS_IntegratePosition_Set00(real & _step);
	void		_L_IntegratePosition_Set00(real & _step);
	...
	void		FS_IntegratePosition_PosErrVel_Euler(real & _step);
	void		FS_IntegratePosition_PosErrVel_plus_Velocity_Euler(real & _step);
