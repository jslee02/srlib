...
void srRevoluteState::UpdatePosition(real& t)
{
	m_rValue[0] += t * m_rValue[1];
}

void srRevoluteState::UpdateVelocity(real& t)
{
...
void srRevoluteState::UpdateAccWithDelVel(real& fps)	// fps == reciprocal of time step
{
	m_rValue[2] += fps * m_rDelVel;
}

void srRevoluteState::UpdateTorqueWithImp(real& fps)
{
	m_rValue[3] += fps * m_rImp;
}

void srRevoluteState::UpdatePosWithPosErrVel(real& t)
{
...
void srRevoluteState::UpdatePosWithCorrection(real& t)
{
...
void srUniversalState::UpdatePosition(real & t)
{
	m_rValue[0][0] += t * m_rValue[0][1];
	m_rValue[1][0] += t * m_rValue[1][1];
}

void srUniversalState::UpdateVelocity(real & t)
{
...
void srUniversalState::UpdateAccWithDelVel(real & fps)
{
	m_rValue[0][2] += fps * m_rDelVel[0];
	m_rValue[1][2] += fps * m_rDelVel[1];
}

void srUniversalState::UpdateTorqueWithImp(real & fps)
{
	m_rValue[0][3] += fps * m_rImp[0];
	m_rValue[1][3] += fps * m_rImp[1];
}

void srUniversalState::UpdatePosWithPosErrVel(real & t)
{
...
void srUniversalState::UpdatePosWithCorrection(real & t)
{
...
void srBallState::UpdatePosition(real & t)
{
	m_SO3Pos = m_SO3Pos * Exp(t * m_Vel);
}

void srBallState::UpdateVelocity(real & t)
{
	m_Vel += t * m_Acc;
}
...
void srBallState::UpdateAccWithDelVel(real & fps)
{
	m_Acc += fps * m_DelVel;
}

void srBallState::UpdateTorqueWithImp(real & fps)
{
	m_Torque += fps * m_Imp;
}

void srBallState::UpdatePosWithPosErrVel(real & t)
{
...
void srBallState::UpdatePosWithCorrection(real & t)
{
