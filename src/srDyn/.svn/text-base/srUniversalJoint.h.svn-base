...
public:
	...
	*/
	real	GetPositionLowerLimit(int idx = 0);
	/*!
		Get upper limit of joint angle.
		Get real value for the first angle of joint when idx equals 0.
		Get real value for the second angle of joint when idx equals 1.
	*/
	real	GetPositionUpperLimit(int idx = 0);
	/*!
	...
	*/
	void	SetPositionLimit(real lowerlimit, real upperlimit, int idx = 2);
	/*!
		Get lower limit of joint torque.
		Get real value for the first angle of joint when idx equals 0.
		Get real value for the second angle of joint when idx equals 1.
	*/
	real	GetTorqueLowerLimit(int idx = 0);
	/*!
		Get upper limit of joint torque.
		Get real value for the first angle of joint when idx equals 0.
		Get real value for the second angle of joint when idx equals 1.
	*/
	real	GetTorqueUpperLimit(int idx = 0);
	/*!
		...
		Set real values for both angles of joint when idx equals 2.
	*/
	void	SetTorqueLimit(real lowerlimit, real upperlimit, int idx = 2);
	/*!
		Get offset.
		Get real value for the first angle of joint when idx equals 0.
		Get real value for the second angle of joint when idx equals 1.
	*/
	real	GetOffset(int idx = 0);
	/*!
		Set offset.
		Set real values for the first angle of joint when idx equals 0.
		Set real values for the second angle of joint when idx equals 1.
	*/
	void	SetOffset(real v, int idx = 0);
	/*!
		Get spring coefficient.
		Get real value for the first angle of joint when idx equals 0.
		Get real value for the second angle of joint when idx equals 1.
	*/
	real	GetSpringCoeff(int idx = 0);
	/*!
		...
		Set real values for both angles of joint when idx equals 2.
	*/
	void	SetSpringCoeff(real v, int idx = 2);
	/*!
		Get damping coefficient.
		Get real value for the first angle of joint when idx equals 0.
		Get real value for the second angle of joint when idx equals 1.
	*/
	real	GetDampingCoeff(int idx = 0);
	/*!
		...
		Set real values for both angles of joint when idx equals 2.
	*/
	void	SetDampingCoeff(real v, int idx = 2);
	/*!
...
public:
	...
	*/
	...
	real			 m_FS_K_1, m_FS_K_2;
	AInertia		 m_FS_AI_med;
	real			 m_FS_T1, m_FS_T2;
	se3				 m_FS_W1, m_FS_W2;
