...
real srLink::GetRestitution()
{
	return m_Restitution;
}

real srLink::GetFriction()
{
	return m_Friction;
}

real srLink::GetDamping()
{
	return m_Damping;
}
void srLink::SetRestitution(real v)
{
	if (v >= 0.0)
		m_Restitution = v;
}
void srLink::SetFriction(real v)
{
	if (v >= 0.0)
		m_Friction = v;
}
void srLink::SetDamping(real v)
{
	if (v >= 0.0)
		m_Damping = v;
}
...
void srLink::UpdateInertia(real density)
{
...
void srLink::FS_UpdateImpulse_Link(real & _fps)
{
