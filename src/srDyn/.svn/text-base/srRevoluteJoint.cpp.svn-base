...
real srRevoluteJoint::GetPositionLowerLimit()
{
	return m_PosLimit[0];
}

real srRevoluteJoint::GetPositionUpperLimit()
{
	return m_PosLimit[1];
}

void srRevoluteJoint::SetPositionLimit(real lowerlimit, real upperlimit)
{
...
real srRevoluteJoint::GetTorqueLowerLimit()
{
	return m_TorqueLimit[0];
}

real srRevoluteJoint::GetTorqueUpperLimit()
{
	return m_TorqueLimit[1];
}

void srRevoluteJoint::SetTorqueLimit(real lowerlimit, real upperlimit)
{
	if ( lowerlimit < upperlimit )
	{
...
real srRevoluteJoint::GetOffset()
{
	return m_rOffset;
}

void srRevoluteJoint::SetOffset(real v)
{
	m_rOffset = v;
}

real srRevoluteJoint::GetSpringCoeff()
{
	return m_rK;
}

void srRevoluteJoint::SetSpringCoeff(real v)
{
	if (v >= 0.0)
		m_rK = v;
}

real srRevoluteJoint::GetDampingCoeff()
{
	return m_rC;
}

void srRevoluteJoint::SetDampingCoeff(real v)
{
	if (v >= 0.0)
		m_rC = v;
}
