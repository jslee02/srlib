...
//======= MARK9 =======//
	...
	// Space variables
	real								m_Timestep_fixed;
	real								m_FPS_fixed; // frame per second  ( : 1/timestep )
	...
	void	PRESTEP_MARK9(SystemPtrArray & _systemptrarray, LinkPtrArray & _linkptrarray, JointPtrArray & _jointptrarray, real & _timestep, real & _fps);

	void	_PRESTEP_Set_SpaceVariables___________________MARK9(real & _timestep, real & _fps);
