...
real srPrismaticJoint::GetPositionLowerLimit()
{
	return m_PosLimit[0];
}

real srPrismaticJoint::GetPositionUpperLimit()
{
	return m_PosLimit[1];
}

void srPrismaticJoint::SetPositionLimit(real lowerlimit, real upperlimit)
{
...
real srPrismaticJoint::GetTorqueLowerLimit()
{
	return m_TorqueLimit[0];
}

real srPrismaticJoint::GetTorqueUpperLimit()
{
	return m_TorqueLimit[1];
}

void srPrismaticJoint::SetTorqueLimit(real lowerlimit, real upperlimit)
{
	if ( lowerlimit < upperlimit )
	{
...
real srPrismaticJoint::GetOffset()
{
	return m_rOffset;
}

void srPrismaticJoint::SetOffset(real v)
{
	m_rOffset = v;
}

real srPrismaticJoint::GetSpringCoeff()
{
	return m_rK;
}

void srPrismaticJoint::SetSpringCoeff(real v)
{
	if (v >= 0.0)
		m_rK = v;
}

real srPrismaticJoint::GetDampingCoeff()
{
	return m_rC;
}

void srPrismaticJoint::SetDampingCoeff(real v)
{
	if (v >= 0.0)
		m_rC = v;
}
