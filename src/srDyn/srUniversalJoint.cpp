...
real srUniversalJoint::GetPositionLowerLimit(int idx /*= 0*/)
{
	if (idx == 0)
...
real srUniversalJoint::GetPositionUpperLimit(int idx /*= 0*/)
{
	if (idx == 0)
...
void srUniversalJoint::SetPositionLimit(real lowerlimit, real upperlimit, int idx /*= 2*/)
{
...
real srUniversalJoint::GetTorqueLowerLimit(int idx /*= 0*/)
{
	if (idx == 0)
...
real srUniversalJoint::GetTorqueUpperLimit(int idx /*= 0*/)
{
	if (idx == 0)
...
void srUniversalJoint::SetTorqueLimit(real lowerlimit, real upperlimit, int idx /*=2*/)
{
	if ( lowerlimit < upperlimit )
	{
		if (idx == 0)
...
real srUniversalJoint::GetOffset(int idx)
{
	if (idx == 0)
		return m_rOffset[0];
	else if (idx == 1)
...
void srUniversalJoint::SetOffset(real v, int idx)
{
	if (idx == 0)
		m_rOffset[0] = v;
	else if (idx == 1)
...
real srUniversalJoint::GetSpringCoeff(int idx)
{
	if (idx == 0)
		return m_rK[0];
	else if (idx == 1)
...
void srUniversalJoint::SetSpringCoeff(real v, int idx)
{
	if (v >= 0.0)
	{
		if (idx == 0)
...
real srUniversalJoint::GetDampingCoeff(int idx)
{
	if (idx == 0)
		return m_rC[0];
	else if (idx == 1)
...
void srUniversalJoint::SetDampingCoeff(real v, int idx)
{
	if (v >= 0.0)
	{
		if (idx == 0)
