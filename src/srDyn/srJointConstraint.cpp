...
real JointConstraint::erp_jointpositionlimit = 0.8;
real JointConstraint::allowedjointerror = 0.0001;
real JointConstraint::bouncing_threshold = 0.2;
real JointConstraint::maximum_erp_velocity = 10;
real JointConstraint::maximum_bouncing_velocity = 20;

void JointConstraint::SetErp(real _erp)
{
	erp_jointpositionlimit = _erp;
}

void JointConstraint::SetAllowedPenetration(real _allowedpenetration)
{
	allowedjointerror = _allowedpenetration;
}

void JointConstraint::SetBouncingThreshold(real _bouncingthreshold)
{
	bouncing_threshold = _bouncingthreshold;
}

void JointConstraint::SetMaximumErpVelocity(real _maximum_erp_velocity)
{
	maximum_erp_velocity = _maximum_erp_velocity;
}

void JointConstraint::SetMaximumBouncingVelocity(real _maximum_bouncing_velocity)
{
...
void JointConstraint::_getdelvelocity_R(real * sjari)
{
...
void JointConstraint::_getdelvelocity_P(real * sjari)
{
	if (pSystem->m_bExcited)
...
void JointConstraint::_getdelvelocity_U_1(real * sjari)
{
	if (pSystem->m_bExcited)
...
void JointConstraint::_getdelvelocity_U_2(real * sjari)
{
	if (pSystem->m_bExcited)
...
void JointConstraint::_getdelvelocity_B_Y(real * /* sjari */)
{
	// 미구현
}

void JointConstraint::_getdelvelocity_B_RP(real * /* sjari */)
{
	// 미구현
}

void JointConstraint::GetDelVelocity(real * sjari)
{
...
void JointConstraint::_setimpulse_R(real * _lambda)
{
	m_pRstate->m_rImp += _lambda[0];
}

void JointConstraint::_setimpulse_P(real * _lambda)
{
	m_pPstate->m_rImp += _lambda[0];
}

void JointConstraint::_setimpulse_U_1(real * _lambda)
{
	m_pUstate->m_rImp[0] += _lambda[0];
}

void JointConstraint::_setimpulse_U_2(real * _lambda)
{
	m_pUstate->m_rImp[1] += _lambda[0];
}

void JointConstraint::_setimpulse_B_Y(real * /* _lambda */)
{
	// 미구현
}

void JointConstraint::_setimpulse_B_RP(real * /* _lambda */)
{
	// 미구현
}

void JointConstraint::SetImpulse(real * _lambda)
{
	lambda = _lambda[0];
